import { addUser, getReferrals, removeUser, updateUser } from '../models/userqueries.js';
import { calculateReferralPoints } from '../../config/common.js';

export const saveUserData = async (req, res) => {
    try {
        const { name, referralCode } = req.body;
        const { referralPoints, referrerPoints, referralPointsId, referrerCode } = await calculateReferralPoints(referralCode);
